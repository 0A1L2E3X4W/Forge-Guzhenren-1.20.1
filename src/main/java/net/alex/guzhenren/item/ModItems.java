...
import net.alex.guzhenren.item.custom.custom_gu.human.PrimevalElderGu;
import net.alex.guzhenren.item.custom.custom_material.gu_materials.PrimevalStone;
import net.alex.guzhenren.item.custom.custom_gu.heaven.LifespanGu;
import net.alex.guzhenren.item.custom.custom_gu.heaven.Hope;
...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, GuzhenrenMod.MOD_ID);
