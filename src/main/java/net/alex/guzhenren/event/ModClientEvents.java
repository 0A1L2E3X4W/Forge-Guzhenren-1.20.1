...
import net.alex.guzhenren.client.gui.ClientStatsGuiOverlay;
import net.alex.guzhenren.client.hud.ClientStatsHudOverlay;
import net.alex.guzhenren.utils.ModKeyBindings;
...
public class ModClientEvents {
    ...
    @Mod.EventBusSubscriber(modid = GuzhenrenMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
    ...
    @Mod.EventBusSubscriber(modid = GuzhenrenMod.MOD_ID, value = Dist.CLIENT)
